...
describe("Authentication constants", () => {
  describe("AUTH_CONFIG", () => {
    ...
    it("should have valid username constraints", () => {
      ...
      expect(AUTH_CONFIG.MAX_USERNAME_LENGTH).toBeGreaterThan(
  ...
  describe("AUTH_ERRORS", () => {
    ...
    it("should have user-friendly error messages", () => {
      ...
      expect(AUTH_ERRORS.USERNAME_TOO_SHORT).toContain(
        AUTH_CONFIG.MIN_USERNAME_LENGTH.toString(),
      );
      expect(AUTH_ERRORS.USERNAME_TOO_LONG).toContain(
        AUTH_CONFIG.MAX_USERNAME_LENGTH.toString(),
      );
      expect(AUTH_ERRORS.PASSWORD_TOO_SHORT).toContain(
        AUTH_CONFIG.MIN_PASSWORD_LENGTH.toString(),
      );
    });
